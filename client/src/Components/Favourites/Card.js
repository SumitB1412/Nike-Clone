...
import { removeFromFavourites } from "../../Redux/favourites/actions";
...
const Card = ({ product }) => {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div>
        <p className="text-gray-400 max-w-[27ch] truncate">
          {product.description}
        </p>
      </div>
      <div className="py-4">
        <button
          ...
          className="px-4 py-2 border border-gray-300 hover:border-gray-700 rounded-full"
        >
          Remove
        </button>
      </div>
