  ...
  return (
    <div className="hidden md:flex w-full justify-between items-center h-16 px-1">
      ...
      <ul className="hidden md:flex">
        <li className="p-4 relative after:absolute after:w-0 hover:after:w-full after:h-[2px] after:left-0 after:bottom-0 after:bg-black cursor-pointer"><Link to={'/products'}>New & Featured</Link></li>
